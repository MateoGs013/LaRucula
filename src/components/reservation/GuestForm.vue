...
<template>
  <div class="guest-form">
    <div class="space-y-6">
      <!-- Name -->
      <div>
        <label for="guest-name" class="eyebrow mb-2 block text-[0.75rem]">Name *</label>
        <input
          id="guest-name"
          type="text"
          :value="guest.name"
      ...
      <!-- Phone -->
      <div>
        <label for="guest-phone" class="eyebrow mb-2 block text-[0.75rem]">Phone *</label>
        <input
          id="guest-phone"
          type="tel"
          :value="guest.phone"
      ...
      <!-- Email -->
      <div>
        <label for="guest-email" class="eyebrow mb-2 block text-[0.75rem]">Email</label>
        <input
          id="guest-email"
          type="email"
          :value="guest.email"
      ...
      <!-- Notes -->
      <div>
        <label for="guest-notes" class="eyebrow mb-2 block text-[0.75rem]">Special requests</label>
        <textarea
          id="guest-notes"
          :value="guest.notes"
