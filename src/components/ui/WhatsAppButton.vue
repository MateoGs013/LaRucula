 ...
 * Fixed position, bottom-right, always accessible.
 * Uses the brand visual language — not a generic green circle.
 */
...
// Delay appearance to avoid competing with hero entrance
onMounted(() => {
